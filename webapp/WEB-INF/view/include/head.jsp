...
<link rel="icon" type="image/png" sizes="96x96" href="${ctxStatic}/vendor/bootstrap/css/datapicker.css">
...
<script src="${ctxStatic}/vendor/bootstrap/js/dataPicker.js"></script>