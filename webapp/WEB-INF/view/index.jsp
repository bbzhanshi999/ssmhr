...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="brand">
            <a href="index.html"><img src="${ctxStatic}/img/logo.gif" alt="Klorofil Logo"
        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li>
                        <a href="#chart_manager" data-toggle="collapse" class="collapsed"><i
                                class="lnr lnr-file-empty"></i> <span>报表管理</span> <i
                                class="icon-submenu lnr lnr-chevron-left"></i></a>
    ...
    <footer>
        <div class="container-fluid">
            <p class="copyright">Copyright &copy; neusoft</p>
